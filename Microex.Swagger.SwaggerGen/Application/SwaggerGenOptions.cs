...
using Microex.Swagger.SwaggerGen.Annotations;
...
namespace Microex.Swagger.SwaggerGen.Application
{
    public class SwaggerGenOptions
    {
        ...
        /// <summary>
        /// If applicable, enum members would be described as a key-displayname pair, should work with string enum.
        /// </summary>
        public void AttachEnumDisplayNameMeta()
        {
            _schemaRegistrySettings.AttachEnumDisplayNameMeta = true;
        }
